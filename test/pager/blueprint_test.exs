defmodule Pager.BlueprintTest do
  ...
  describe "default provider" do
    test "disables the first page when current page it's already the first one" do
      blueprint =
        Pager.Providers.Default.explain(%Pager.Page{
          current_page: 1,
          total_items: 50,
          page_size: 10
        })
  ...
  describe "compact provider" do
    test "disables the first page when current page it's already the first one" do
      blueprint =
        Pager.Providers.Compact.explain(%Pager.Page{
          current_page: 1,
          total_items: 50,
          page_size: 10
        })
    ...
    test "enables the next page when it's relevant" do
      blueprint =
        Pager.Blueprint.explain(%Pager.Page{current_page: 4, total_items: 50, page_size: 10})
